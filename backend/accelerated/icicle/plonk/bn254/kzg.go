...
//
// Provenance: github.com/consensys/gnark-crypto v0.20.1, ecc/bn254/kzg/kzg.go.
...
// ∑_{i<len(p)}p[i]Xⁱ
//
// cloned byte-faithfully from gnark-crypto v0.20.1 ecc/bn254/kzg/kzg.go:57-64
// (unexported upstream).
...
//
// cloned byte-faithfully from gnark-crypto v0.20.1 ecc/bn254/kzg/kzg.go:593-614
// (unexported upstream).
...
//
// cloned byte-faithfully from gnark-crypto v0.20.1 ecc/bn254/kzg/kzg.go:558-591
...
//
// Clone of gnark-crypto v0.20.1 ecc/bn254/kzg/kzg.go:158-177 (Commit) with the
...
//
// Clone of gnark-crypto v0.20.1 ecc/bn254/kzg/kzg.go:179-205 (Open) with the
...
//
// Clone of gnark-crypto v0.20.1 ecc/bn254/kzg/kzg.go:248-341
