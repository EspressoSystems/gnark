...
// deriveRandomness cloned from backend/plonk/bn254/verify.go:315-379 at the
...
// [icicle] The proof type is the native [plonk_bn254.Proof]: the clone
...
func Prove(spr *cs.SparseR1CS, pk *ProvingKey, fullWitness witness.Witness, opts *icicle.Config) (*plonk_bn254.Proof, error) {
...
//
// [icicle] cloned byte-faithfully from backend/plonk/bn254/verify.go:315-359
...
// vk parameter type, qualified as *plonk_bn254.VerifyingKey. The byte
...
//
// [icicle] cloned byte-faithfully from backend/plonk/bn254/verify.go:361-379
// at commit c74a2dc8b890c3d7d196bf20d857a1e482ac57f7 (unexported upstream;
