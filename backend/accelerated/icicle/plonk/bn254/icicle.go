...
// lifted from groth16/bn254/icicle.go (getDeviceProveMutex), then hoisted
func getDeviceMutex(deviceID int32) *sync.Mutex {
	return devicemutex.Get(deviceID)
}

// lifted from groth16/bn254/icicle.go (projectiveToGnarkAffine, g1ProjectiveToG1Jac)
...
// lifted from groth16/bn254/icicle.go (msmChunkedG1)
...
// lifted from groth16/bn254/icicle.go (configureMSM, chunkCountFromCap,
