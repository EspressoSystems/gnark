...
// CLONE of the native BLS12-377 PLONK prover for the ICICLE backend (DESIGN.md
// §12 P3.5/P3.6).
//
// Provenance: backend/plonk/bls12-377/prove.go at gnark commit
...
// deriveRandomness cloned from backend/plonk/bls12-377/verify.go:315-379 at the
...
//
//	diff -u backend/plonk/bls12-377/prove.go backend/accelerated/icicle/plonk/bls12-377/prove.go
//
...
// [icicle] The proof type is the native [plonk_bls12377.Proof]: the clone
...
func Prove(spr *cs.SparseR1CS, pk *ProvingKey, fullWitness witness.Witness, opts *icicle.Config) (*plonk_bls12377.Proof, error) {
...
func newInstance(ctx context.Context, spr *cs.SparseR1CS, pk *ProvingKey, fullWitness witness.Witness, opts *backend.ProverConfig, device *icicle_runtime.Device) (*instance, error) {
	...
	// build trace
	s.trace = plonk_bls12377.NewTrace(spr, s.domain0)
...
func commitToQuotient(device *icicle_runtime.Device, h1, h2, h3 []fr.Element, proof *plonk_bls12377.Proof, kzgPk kzg.ProvingKey, devKzg icicle_core.DeviceSlice) error {
	g := new(errgroup.Group)
...
//
// [icicle] cloned byte-faithfully from backend/plonk/bls12-377/verify.go:315-359
...
// vk parameter type, qualified as *plonk_bls12377.VerifyingKey. The byte
...
//
// [icicle] cloned byte-faithfully from backend/plonk/bls12-377/verify.go:361-379
// at commit c74a2dc8b890c3d7d196bf20d857a1e482ac57f7 (unexported upstream;
