...
// lifted from groth16/bls12-377/icicle.go (loadG1), with the allocation made
...
// lifted from groth16/bls12-377/icicle.go (msmChunkedG1)
...
// lifted from groth16/bls12-377/icicle.go (configureMSM, chunkCountFromCap,
